...
### How it works
* Clicking the `Save as Read-Only` button bakes all current views and hotspots into a finalized HTML file, completely stripping all editing controls, configuration panels, and menus from the recipient's viewer interface.

<!-- ####################################################################################################### -->

## ✨ Panorama Branding & Metadata

Inside the browser-based virtual tour editor, you will find a new **"Edit Details"** button. This allows you to set global metadata for your panorama:

*   **Title** — The name of your panorama, displayed in the bottom-left corner.
...
All metadata is automatically bundled into the final standalone HTML file upon saving.
...
### How it works
1. Run the command to start the interactive configuration wizard.
2. Enter your **Author Name** (e.g., *Superman*).
3. Enter your **Author URL** (e.g., *https://site.com*).
4. Done! Your global settings are permanently saved to `~/.html360.json` in your home folder and will be used as defaults.
