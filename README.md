...
### How it works
* **Configuration locking:** Clicking the `Save as Read-Only` button bakes all current views and hotspots into a finalized HTML file, completely stripping all editing controls, configuration panels, and menus from the recipient's viewer interface.
